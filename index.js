...
browser: ['Elaina Bot WhatsApp (2022)','Safari','1.0.0'],
auth: state,
version
})
...
console.log(color(figlet.textSync(`Elaina`, {
font: 'Standard',
...
if (anu.action == 'add') {
kayla.sendMessage(anu.id, { text : `Hello Sis @${num.split("@")[0]}, Welcome To The Group ${metadata.subject}, I Hope You Enjoy It, Nii-chan`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM DARI ELAINA BOT"
	}
],
"selectableOptionsCount": 5
}}}})
} else if (anu.action == 'remove') {
kayla.sendMessage(anu.id, { text : `Goodbye Nii-san TwT @${num.split("@")[0]}, I Hope You Feel At Home In Nature`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
participant: `0@s.whatsapp.net`, 
...({ remoteJid: "status@broadcast" }) 
...
"url": `https://m.youtube.com/channel/UCmi8oCjIr8ITD80Tb-05GQA`,
"productImageCount": 1,
"salePriceAmount1000": "0"
},
"businessOwnerJid": `6285869074622@s.whatsapp.net`
}
}, options)
